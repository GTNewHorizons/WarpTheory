...
public class BlockCoord implements Comparable {
    ...
    public boolean isAir(IBlockAccess access) {
        return access.isAirBlock(this.x, this.y, this.z);
    }

    public boolean isTopSolid(IBlockAccess access) {
        return access.isSideSolid(this.x, this.y, this.z, ForgeDirection.UP, false);
    }
