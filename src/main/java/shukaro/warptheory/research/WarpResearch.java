...
public class WarpResearch {
    ...
    public static void init() {
        ...
        new WTResearchItem(
                ...
                .setParents("ELDRITCHMAJOR", Constants.ITEM_LITMUS, "FAKEELDMAJOR")
                .setHidden()
                .setItemTriggers(ItemApi.getItem("itemSanitySoap", 0))
        ...
        new WTResearchItem(
                ...
                .setParents(Constants.ITEM_WARPCLEANSER)
                .setConcealed()
                .registerResearchItem();
        ...
        new WTResearchItem(
                ...
                .setPages(somethingPages)
                .setParents("FAKESOAP")
                .setSecondary()
                .setAspectTriggers(Aspect.ELDRITCH, Aspect.FLESH, Aspect.EXCHANGE)
                .registerResearchItem();
        ...
        new WTResearchItem(
                ...
                .setConcealed()
                .setParents("FAKESOAP")
                .setAspectTriggers(Aspect.ELDRITCH, Aspect.MAGIC, Aspect.SENSES)
                .registerResearchItem();
    }
}
